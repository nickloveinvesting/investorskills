---
name: dscr-lender-matcher
description: >
  Match the deal to the right loan product before you waste three weeks with the wrong lender.
  Use for: First-Deal Investor, Fix-and-Flipper. Category: Funding & Capital Raise.
triggers:
  - dscr
  - lender
  - loan
...
- When you are working a first-deal investor deal and need this step done consistently
...
Written for First-Deal Investor, Fix-and-Flipper.
