...
description: >
  Send the quarterly update that keeps capital coming back, including how to report a bad quarter.
  Use for: Small Multifamily Investor. Category: Funding & Capital Raise.
triggers:
  - investor
  - update
  - writer
