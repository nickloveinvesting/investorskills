---
name: skip-trace-triage
description: >
  Rank skip trace output by which number is likely to be answered by the actual decision maker.
  Use for: Wholesaler. Category: Lead Generation & List Building.
triggers:
  - result
  - skip
  - trace
