---
name: closing-timeline-manager
description: >
  Run the contract-to-close calendar backwards from funding so no deadline gets discovered late.
  Use for: Wholesaler, Fix-and-Flipper. Category: Contracts & Transaction Ops.
triggers:
  - closing
  - manager
  - timeline
...
- When you are working a wholesaler deal and need this step done consistently
...
Written for Wholesaler, Fix-and-Flipper.
