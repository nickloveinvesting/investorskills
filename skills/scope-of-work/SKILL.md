...
name: scope-of-work
description: >
  Turn a walkthrough into a line-item scope contractors can bid apples-to-apples against.
  Use for: Fix-and-Flipper, Small Multifamily Investor. Category: Rehab Scoping & Contractors.
triggers:
  - generator
  - scope
  - work
...
- When you are working a fix-and-flipper deal and need this step done consistently
...
Written for Fix-and-Flipper, Small Multifamily Investor.
