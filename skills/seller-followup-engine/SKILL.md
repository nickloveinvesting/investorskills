---
name: seller-followup-engine
description: >
  Build the twelve-month follow-up cadence that closes the deals your competitors abandoned after two calls.
  Use for: Wholesaler. Category: Seller Outreach & Negotiation.
triggers:
  - engine
  - follow
  - followup
