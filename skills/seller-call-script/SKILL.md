---
name: seller-call-script
description: >
  Run a first seller call that surfaces motivation and condition without triggering the defensive wall a pitch creates.
  Use for: Wholesaler, First-Deal Investor. Category: Seller Outreach & Negotiation.
triggers:
  - call
  - script
  - seller
