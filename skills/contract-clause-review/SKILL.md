...
description: >
  Read a purchase agreement for the four clauses that decide whether you can actually walk away.
  Use for: Wholesaler, First-Deal Investor. Category: Contracts & Transaction Ops.
triggers:
  - clause
  - contract
  - purchase
...
version: 0.1.0
---
# Purchase Contract Clause Review
