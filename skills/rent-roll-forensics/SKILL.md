---
name: rent-roll-forensics
description: >
  Find the inflated income and buried expenses a broker's package is built to hide before you go hard on earnest money.
  Use for: Small Multifamily Investor. Category: Deal Analysis & Underwriting.
triggers:
  - forensics
  - rent
  - roll
...
Written for Small Multifamily Investor.
